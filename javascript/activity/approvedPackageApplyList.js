...
define(function (require, exports, module){
    ...
    function setFormParam() {
        ...
        lstParam.status = _urlParamToJson(window.location.href,'status');
    }
    function renderTable(data) {
        var tpl = require('../template/approvedPackageApplyList.tpl');
    ...
    function loadList() {
        ...
        $.get(
            PER_REI_DOMAIN + '/approvedPackageApplyList/query',
            lstParam,
