    ...
    $.extend($.PaginationRenderers.defaultRenderer.prototype, {
        ...
        createLink : function(page_id, current_page, appendopts) {
            ...
            if (page_id == current_page) {
                var isendName = appendopts.end||false;
                var className = appendopts.current_cls || "selected";
                if(className=="selected"){
                    lnk = $("<span isend='"+ isendName +"' class='" + className + "'>" + appendopts.text + "</span>");
                }else if(className=="disabled"){
                    lnk = $("<span isend='"+ isendName +"' class='" + className + "'>" + appendopts.text + "</span>");
                }else{
                    lnk = $("<a isend='"+ isendName +"' class='" + className + "'>" + appendopts.text + "</a>");
                }
            } else {
        ...
        getLinks : function(current_page, eventHandler, cls) {
            ...
            if (this.opts.jump) {
                ...
                $("input.jumpnum").live("keypress",function(e){
                    var curKey = e.which;
                    if(curKey == "13") {
                        $(".jumpbtn").click();
                    }
